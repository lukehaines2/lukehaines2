...
I'm a Front End Developer working and living in London. I have a background in graphic design so it's probably no surprise that when push comes to shove, I'd definitely prefer tweaking CSS rather than a SQL query... but I'd happily have a go at both! When I'm not coding it's safe to say I'll be doing something related to the financial markets, wether it be researching/investing/trading/building. See what I'm up to on [![Twitter][1.2]][1] or [![LinkedIn][2.2]][2].
